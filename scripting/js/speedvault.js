...
$(document).ready(function() {
	...
	<div class="infoBox">\
	<div class="nowPlaying"><h4 class="svTitle svTitleFix">Select a video from the gallery to play in this section</h4></div>\
	</div>\
	</div>');
...
// Youtube Video
    $('.ytVideo').each(function() {
        ...
        $ytThumb = $('<img src="https://img.youtube.com/vi/' + $videoID + '/mqdefault.jpg" data-anchor=""/>');
...
// Vimeo Video
    $('.vimeoVideo').each(function() {
     ...
     $vimeoThumb = $('<img src="https://player.vimeo.com/video/' + $videoID + '/mqdefault.jpg" data-anchor="svBox"/>');
   $thisElHack = this;
